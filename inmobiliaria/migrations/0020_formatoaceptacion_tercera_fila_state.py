# Sincroniza el estado de migraciones con los campos de la tercera fila de referencias.
# Las columnas ya se crearon en 0018 (RunSQL); RunSQL no actualiza el estado del proyecto.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("inmobiliaria", "0019_formato_aceptacion_contrato_opcional"),
    ]
