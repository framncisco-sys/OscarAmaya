...
def marcar_pendiente_si_operador(obj, user) -> bool:
    """
    Si el usuario no es admin/gerencia, marca el registro como pendiente.
    Admin/gerencia al guardar queda validado. Devuelve True si quedó pendiente.
    """
    ...
    if isinstance(obj, Contrato):
        # No queda activo hasta que gerencia valide.
